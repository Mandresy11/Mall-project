...
describe('DashboardComponent', () => {
  ...
  beforeEach(async () => {
    ...
    // Réinitialise les mocks Vitest entre chaque test
    vi.clearAllMocks();
  ...
  it('la 4e KPI card a un suffixe %', fakeAsync(() => {
    tick();
    fixture.detectChanges();
    expect(component.statCards[3].suffix).toBe('%');
  }));
  ...
  it('devrait filtrer les boutiques par nom', fakeAsync(() => {
    ...
    component.onSearch({ target: { value: 'nike' } } as unknown as Event);
  ...
  it('devrait filtrer les boutiques par catégorie', fakeAsync(() => {
    ...
    component.onSearch({ target: { value: 'mode' } } as unknown as Event);
  ...
  it('devrait afficher 0 résultat pour une recherche sans correspondance', fakeAsync(() => {
    ...
    component.onSearch({ target: { value: 'xxxxxxinexistant' } } as unknown as Event);
  ...
  it('devrait mettre à jour searchQuery', fakeAsync(() => {
    ...
    component.onSearch({ target: { value: 'apple' } } as unknown as Event);
  ...
  it('devrait passer hasError à true si le service échoue', fakeAsync(() => {
